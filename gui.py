...
home_button = ctk.CTkButton(navigation_bar, width=120, height=40, text="Home", font=("ADLaM Display", 20), border_width=2, border_color="white", fg_color="#16CCCC", hover_color="#c7c7c7")
...
drills_button = ctk.CTkButton(navigation_bar, height=40, text="Drills", font=("ADLaM Display", 20), border_width=2, border_color="white", fg_color="#16CCCC", hover_color="#c7c7c7")
...
previous_plans_button = ctk.CTkButton(navigation_bar, height=40, text="Previous Training Plans", font=("ADLaM Display", 20), border_width=2, border_color="white", fg_color="#16CCCC", hover_color="#c7c7c7")
...
import_stats_button = ctk.CTkButton(right_column, text="Import Statistics", font=("ADLaM Display", 25), height=50, width=50, fg_color="#FF7A53", hover_color="#c7c7c7")
...
generate_plan_button = ctk.CTkButton(right_column, text="Generate Training Plan", font=("ADLaM Display", 25), image=file_icon, height=50, width=50, fg_color="#FF7A53", compound="right", hover_color="#c7c7c7")
...
new_drill_button = ctk.CTkButton(right_column, text="Add New Drill", font=("ADLaM Display", 25), height=50, width=50, fg_color="#FF7A53", image=drills_icon, compound="right", hover_color="#c7c7c7")
...
left_column = ctk.CTkFrame(app, border_width=2, border_color="grey")

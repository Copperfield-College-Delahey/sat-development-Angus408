...
right_column = ctk.CTkFrame(app, width=600, bg_color="#F2F2F2", fg_color="#F2F2F2")
...
left_column = ctk.CTkFrame(app, border_width=2, corner_radius=0, border_color="#7F7F7F", bg_color="#F2F2F2", fg_color="#F2F2F2")
